...
module.exports = __webpack_require__(/*! C:\Alexandra\Pluralsight\DutchTree\ClientApp\main.ts */"QqbR");
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"],
        ...
        _login_login_component__WEBPACK_IMPORTED_MODULE_8__["Login"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"],
        _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClientModule"],
...
class DataService {
    ...
    addToOrder(product) {
        let item = this.order.items.find(_ => _.productId == product.id);
        if (item) {
            item.quantity++;
        }
        else {
